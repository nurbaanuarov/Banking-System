...
import com.example.bankapp.model.UserRole;
...
public class AccountService implements UserDetailsService {
    ...
    public Account registerAccount(String username, String password) {
        ...
        account.setRole(UserRole.NOT_CONFIRMED);
    ...
    public List<Transaction> getTransactionHistory(Account account) {
        return transactionRepository.findByAccountId(account.getId())
                ...
                .sorted(
                        (account1, account2) ->
                                account2.getTimestamp()
                                        .compareTo(account1.getTimestamp())
                )
                .toList();
    }
    ...
    public void confirmUser(String username) {
        accountRepository.findByUsername(username).ifPresent(account -> {
            account.setRole(UserRole.CONFIRMED);
            accountRepository.save(account);
        });
    }
}
